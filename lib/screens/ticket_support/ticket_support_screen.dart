    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            if (ticketData != null) {
              _addTicketBloc.dataofTicketsofuserSubject.add(
                  _addTicketBloc.dataofTicketsofuserSubject.value
                    ..add(ticketData));
            }
          }),
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data!.data!.length > 0) {
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        StreamBuilder<List<TicketData>>(
                            stream: _addTicketBloc
                                .dataofTicketsofuserSubject.stream,
                              ...
                              if (snapshotTicketsofUser.hasData) {
                                if (snapshotTicketsofUser.data!.length > 0) {
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        snapshotTicketsofUser.data!.length,
                                    itemBuilder:
                                      ...
                                      child: Padding(
                                        ...
                                        child: TicketSupport(
                                          subTicket: true,
                                          ticket_id: snapshotTicketsofUser
                                              .data![index].id,
                                          name: snapshotTicketsofUser
                                              .data![index].subject,
                                          message:
                                              '${snapshotTicketsofUser.data![index].details}',
                                          date: snapshotTicketsofUser
                                              .data![index].created_at,
                                          status: snapshotTicketsofUser
                  ...
                  return SizedBox(
                      height: Get.height,
                      child: const Center(child: Text('Not Found Ticket')));
                }
