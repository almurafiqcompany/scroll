...
class TicketSupportReplayBloc {
  ...
  final dataofAllTicketSupportReplaySubject =
      BehaviorSubject<TicketsSupportReplay>();
  ...
  Future<void> fetchAllTicketsSupportReplay({int? ticket_id}) async {
    ...
    try {
      ...
      if (res.statusCode == 200 && res.data['status'] == 200) {
        dataofAllTicketSupportReplaySubject.sink
            .add(TicketsSupportReplay.fromJson(res.data['data']));
