...
class ProfileEditUserDelegateScreen extends StatefulWidget {
  ...
  @override
  _ProfileEditUserDelegateScreenState createState() =>
      _ProfileEditUserDelegateScreenState();
}

class _ProfileEditUserDelegateScreenState
    extends State<ProfileEditUserDelegateScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: GradientAppbar(
        title:
            widget.bedelegate! ? 'side_be_delegate'.tr : 'side_edit_profile'.tr,
      ),
                            ...
                            if (snapshot.hasData && snapshot.data != null) {
                              ...
                              return Center(
                                child: Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      if (getProfileDatasnapshot.data!.avatar !=
                                          null)
                                        ClipRRect(
                                          borderRadius:
                      ...
                      Row(
                        children: [
                          Text('text_full_name'.tr,
                              ...
                              .addPaddingOnly(
                                  right: 8, top: 15, left: 8, bottom: 10),
                          const Text('*',
                                  style: TextStyle(
                                  ...
                                  return TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: GestureDetector(
                                          onTap: () {
                                            _bloc.obscurePasswordSubject.sink
                                                .add(!_bloc
                        ...
                        Padding(
                          ...
                          child: RoundedLoadingButton(
                            ...
                            onPressed: () async {
                              ...
                              await _bloc.confirmEditProfileUserAndDelegate(
                                  context: context, bedelegate: true);
                        ...
                        Padding(
                          ...
                          child: RoundedLoadingButton(
                            ...
                            onPressed: () async {
                              _bloc.loadingButtonController.start();
                              await _bloc.confirmEditProfileUserAndDelegate(
                                  context: context, bedelegate: false);
                              _bloc.loadingButtonController.stop();
                            },
                          ),
                        ),
