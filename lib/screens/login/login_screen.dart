...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> getEmailCach() async {
    try {
      _bloc.emailOrPhoneController.text =
          (await _helper.getEmail() != null ? await _helper.getEmail() : null)!;
        ...
        Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                Text('login'.tr, style: const TextStyle(fontSize: 30)),
                Image.asset(Assets.LOGO).setCenter(),
                Text('text_email'.tr,
                        style: TextStyle(
                            fontSize: 15, color: Colors.grey.shade800))
                    .addPaddingHorizontalVertical(horizontal: 10, vertical: 5),
                StreamBuilder<bool>(
