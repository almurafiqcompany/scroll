...
class PersonalInformationDelegateScreen extends StatefulWidget {
  ...
  @override
  _PersonalInformationDelegateScreenState createState() =>
      _PersonalInformationDelegateScreenState();
}

class _PersonalInformationDelegateScreenState
    extends State<PersonalInformationDelegateScreen> {
  @override
  void initState() {
