...
class AccountInformationDelegateScreen extends StatefulWidget {
  final RegisterDelegateBloc bloc;

  const AccountInformationDelegateScreen({Key key, this.bloc})
      : super(key: key);

  @override
  _AccountInformationDelegateScreenState createState() =>
      _AccountInformationDelegateScreenState();
}

class _AccountInformationDelegateScreenState
    extends State<AccountInformationDelegateScreen> {
  @override
  void initState() {
