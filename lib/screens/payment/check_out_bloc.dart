...
class CheckOutBloc {
  ...
  changePromoCode(String val) =>
      promoCodeSubject.sink.add(validateText(promoCodeController));
  ...
  Future<void> checkOut({
    ...
    try {
      ...
      if (type_payment == 'Cash') {
        formData.fields.add(MapEntry('address_id', '${bank_or_address_id}'));
        formData.fields.add(const MapEntry('type', 'Cash'));
      }
      if (type_payment == 'Bank') {
        formData.fields.add(MapEntry('bank_id', '${bank_or_address_id}'));
        formData.fields.add(const MapEntry('type', 'Bank'));
      }
      if (type_payment == 'PayPal') {
        // formData.fields.add(
        //     MapEntry('bank_id', '${bank_or_address_id}')
        // );
        formData.fields.add(const MapEntry('type', 'PayPal'));
      }
      if (type_payment == 'Tap') {
        // formData.fields.add(
        //     MapEntry('bank_id', '${bank_or_address_id}')
        // );
        formData.fields.add(const MapEntry('type', 'Tap'));
      }
